# 🔧 Troubleshooting Guide — Maven Build Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-maven/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/maven/)
